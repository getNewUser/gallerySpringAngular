...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.onSubmit = function (form, action) {
        var _this = this;
        if (this.name === 'Name..' ||
            this.name === '' ||
            this.username === 'Username..' ||
        ...
        this.auth
            ...
            _this.snackBar.open('You successfully signed up!', action, {
                duration: 2000
            });
        })
            .catch(function (error) {
            _this.snackBar.open('Name or email is already taken!', action, {
                duration: 2000
            });
        });
    };
