...
let CategoriesInputComponent = CategoriesInputComponent_1 = class CategoriesInputComponent {
    constructor() {
        this.onChange = () => { };
        this.onTouch = () => { };
        ...
        providers: [
            {
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => CategoriesInputComponent_1),
                multi: true
            }
        ],
...
let DescriptionInputComponent = DescriptionInputComponent_1 = class DescriptionInputComponent {
    constructor() {
        this.onChange = () => { };
        this.onTouch = () => { };
        ...
        providers: [
            {
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => DescriptionInputComponent_1),
                multi: true
            }
        ],
...
let EmailInputComponent = EmailInputComponent_1 = class EmailInputComponent {
    constructor() {
        this.onChange = () => { };
        this.onTouch = () => { };
        this.val = ''; // this is the updated value that the class accesses
...
EmailInputComponent = EmailInputComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => EmailInputComponent_1),
                multi: true
            }
        ],
...
let NameInputWiderComponent = NameInputWiderComponent_1 = class NameInputWiderComponent {
    constructor() {
        this.val = ''; // this is the updated value that the class accesses
        this.placeholder = '';
        this.isChanged = 0; // set value(val) gets called twice while initializing so I set it's placeholder as val twice just to avoid it being renamed if user inputs something
...
NameInputWiderComponent = NameInputWiderComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => NameInputWiderComponent_1),
                multi: true
            }
        ],
...
let NameInputComponent = NameInputComponent_1 = class NameInputComponent {
    constructor() {
        this.val = ''; // this is the updated value that the class accesses
        this.placeholder = '';
        this.isChanged = 0; // set value(val) gets called twice while initializing so I set it's placeholder as val twice just to avoid it being renamed if user inputs something
...
NameInputComponent = NameInputComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => NameInputComponent_1),
                multi: true
            }
        ],
...
let PasswordInputComponent = PasswordInputComponent_1 = class PasswordInputComponent {
    constructor() {
        this.onChange = () => { };
        this.onTouch = () => { };
        this.val = ''; // this is the updated value that the class accesses
...
PasswordInputComponent = PasswordInputComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        providers: [
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => PasswordInputComponent_1),
                multi: true
            }
        ],
...
let SearchBoxInputComponent = SearchBoxInputComponent_1 = class SearchBoxInputComponent {
    constructor() {
        this.val = ''; // this is the updated value that the class accesses
        this.onChange = () => { };
        this.onTouch = () => { };
...
SearchBoxInputComponent = SearchBoxInputComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        ...
        providers: [
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => SearchBoxInputComponent_1),
                multi: true
            }
        ],
...
let TagsCheckboxInputComponent = TagsCheckboxInputComponent_1 = class TagsCheckboxInputComponent {
    constructor() {
        this.onChange = () => { };
        this.onTouch = () => { };
        this.selectionChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
...
TagsCheckboxInputComponent = TagsCheckboxInputComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        ...
        providers: [
            {
                provide: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NG_VALUE_ACCESSOR"],
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(() => TagsCheckboxInputComponent_1),
                multi: true
            }
        ],
...
let TagsInputComponent = TagsInputComponent_1 = class TagsInputComponent {
    constructor() {
        ...
        this.onChanged = () => { };
        this.onTouched = () => { };
        this.filteredTags = this.tagControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((tag) => tag ? this._filterTag(tag) : this.allTags.slice()));
    }
    set value(val) {
        this.val = val ? val : [''];
        this.onChanged(val);
        ...
        providers: [
            {
                ...
                useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => TagsInputComponent_1),
                multi: true
            }
        ],
...
let ControlAccessorsModule = class ControlAccessorsModule {
};
...
//# sourceMappingURL=default~views-add-add-module~views-gallery-gallerymodule-module~views-login-login-module~views-signu~1811b3e8-es2015.js.map