...
let ItemCountPipe = class ItemCountPipe {
    transform(imageCount) {
        if (imageCount < 10) {
            return imageCount + '';
        }
...
let GallerymoduleModule = class GallerymoduleModule {
};
...
//# sourceMappingURL=views-gallery-gallerymodule-module-es2015.js.map