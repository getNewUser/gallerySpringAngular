...
var AddComponent = /** @class */ (function () {
    function AddComponent(gallery, httpClient, filter, snackBar, router, auth) {
    ...
    AddComponent.prototype.picked = function (event) {
    ...
    AddComponent.prototype.handleInputChange = function (files) {
        var file = files;
        var pattern = /image-*/;
    ...
    AddComponent.prototype.handleReaderLoaded = function (e) {
        var reader = e.target;
        var base64result = reader.result.substr(reader.result.indexOf(',') + 1);
        this.shownPicture = 'data:image/jpg;base64,' + base64result;
        this.fullPicture = base64result;
    };
    AddComponent.prototype.onSubmit = function (f, action) {
        var _this = this;
        ...
        this.httpClient
            ...
            .subscribe(function () {
            _this.snackBar.open('Image added successfully', action, {
                duration: 2000
            });
    ...
    AddComponent.prototype.filterCategories = function (category) {
        this.filter.filter(category, this.selectedCategories);
    };
    AddComponent.prototype.loadCategories = function () {
        var _this = this;
...
//# sourceMappingURL=views-add-add-module-es5.js.map