...
var routes = [
    { path: '', loadChildren: function () { return Promise.all(/*! import() | views-gallery-gallerymodule-module */[__webpack_require__.e("default~views-add-add-module~views-gallery-gallerymodule-module~views-login-login-module~views-signu~1811b3e8"), __webpack_require__.e("views-gallery-gallerymodule-module")]).then(__webpack_require__.bind(null, /*! ./views/gallery/gallerymodule.module */ "./src/app/views/gallery/gallerymodule.module.ts")).then(function (mod) { return mod.GallerymoduleModule; }); } },
    { path: 'update/:id', loadChildren: function () { return Promise.all(/*! import() | views-update-update-module */[__webpack_require__.e("default~views-add-add-module~views-gallery-gallerymodule-module~views-login-login-module~views-signu~1811b3e8"), __webpack_require__.e("views-update-update-module")]).then(__webpack_require__.bind(null, /*! ./views/update/update.module */ "./src/app/views/update/update.module.ts")).then(function (mod) { return mod.UpdateModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] },
    { path: 'login', loadChildren: function () { return Promise.all(/*! import() | views-login-login-module */[__webpack_require__.e("default~views-add-add-module~views-gallery-gallerymodule-module~views-login-login-module~views-signu~1811b3e8"), __webpack_require__.e("views-login-login-module")]).then(__webpack_require__.bind(null, /*! ./views/login/login.module */ "./src/app/views/login/login.module.ts")).then(function (mod) { return mod.LoginModule; }); } },
    { path: 'signup', loadChildren: function () { return Promise.all(/*! import() | views-signup-signup-module */[__webpack_require__.e("default~views-add-add-module~views-gallery-gallerymodule-module~views-login-login-module~views-signu~1811b3e8"), __webpack_require__.e("views-signup-signup-module")]).then(__webpack_require__.bind(null, /*! ./views/signup/signup.module */ "./src/app/views/signup/signup.module.ts")).then(function (mod) { return mod.SignupModule; }); } },
    { path: 'add', loadChildren: function () { return Promise.all(/*! import() | views-add-add-module */[__webpack_require__.e("default~views-add-add-module~views-gallery-gallerymodule-module~views-login-login-module~views-signu~1811b3e8"), __webpack_require__.e("views-add-add-module")]).then(__webpack_require__.bind(null, /*! ./views/add/add.module */ "./src/app/views/add/add.module.ts")).then(function (mod) { return mod.AddModule; }); }, canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]] }
];
...
var PhotodialogComponent = /** @class */ (function () {
    function PhotodialogComponent(dialogRef, data, gallery, snackBar, auth) {
    ...
    PhotodialogComponent.prototype.deleteImage = function (action) {
        ...
        if (confirm('Are you sure you want to delete this image?')) {
            return this.gallery.deleteImage(this.data.id).subscribe(function (data) {
                location.reload();
            });
        }
    };
    PhotodialogComponent.prototype.getFullPicture = function (imageId) {
        var _this = this;
        return this.gallery.getFullPhoto(imageId).subscribe(function (data) {
            _this.fullPhoto = data;
            _this.imgurl = 'data:image/jpg;base64,' + _this.fullPhoto.picture;
        });
    };
    PhotodialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    PhotodialogComponent.ctorParameters = function () { return [
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(auth, snackBar, router) {
        this.auth = auth;
        this.snackBar = snackBar;
        this.router = router;
        this.href = '';
    ...
    HeaderComponent.prototype.logout = function (message, action) {
        this.snackBar.open(message, action, { duration: 2000 });
        this.router.navigate(['login']);
        this.auth.logout();
    };
    HeaderComponent.prototype.getNameForHeader = function () {
...
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var ngx_material_file_input__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ngx-material-file-input */ "./node_modules/ngx-material-file-input/fesm5/ngx-material-file-input.js");
...
var StartsWithCapitalPipe = /** @class */ (function () {
    function StartsWithCapitalPipe() {
    }
    StartsWithCapitalPipe.prototype.transform = function (headerName) {
...
var AuthService = /** @class */ (function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.http
                        ...
                        .toPromise()
                        .then(function (res) {
                        _this.cookie.set('Cookie', res.accessToken);
                        _this.cookieValue = _this.cookie.get('Cookie');
                    })];
            });
        });
    };
    AuthService.prototype.register = function (user) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var email, username, name, password;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                email = user.email;
                ...
                return [2 /*return*/, this.http
                        ...
                        .toPromise()
                        .then(function () { return _this.login(email, password); })];
            });
        });
    };
    ...
    AuthService.prototype.isAdmin = function () {
        var token = this.cookie.get('Cookie');
        var role = atob(token.split('.')[1]);
...
var FilterCategoriesService = /** @class */ (function () {
    function FilterCategoriesService() {
    }
    FilterCategoriesService.prototype.filter = function (tag, selectedTagsOrCategories) {
        if (selectedTagsOrCategories.includes(tag)) {
            for (var i = 0; i < selectedTagsOrCategories.length; i++) {
    ...
    return FilterCategoriesService;
}());
